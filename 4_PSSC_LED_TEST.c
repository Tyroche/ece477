...
/* LED */
uint8_t i2c_b1_enable   = 1;
uint8_t timer_A0_enable = 1;
uint8_t adc12_0_enable  = 1;
...
/* DMA */
uint8_t dma_in_enable	= 0;
uint8_t dma_out_enable	= 0;
...
int main(void)
{
  ...
  if(dac12_enable == 1){
	  ...
	  if (dma_in_enable == 0){
		  ...
		  //DAC12_0CTL0 = DAC12SREF_0 + DAC12AMP_7 + DAC12OG + DAC12ENC + DAC12CALON + ;
		  DAC12_0CTL0 = DAC12LSEL_0 + DAC12IR + DAC12AMP_7 + DAC12IFG + DAC12ENC + DAC12SREF_0;//dma
